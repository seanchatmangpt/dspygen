...
class Conversation(BaseModel):
    ...
    name: str | None = Field(None, description="Name of the conversation, if any.")
...
class ChoreographyTask(BaseModel):
    ...
    name: str | None = Field(None, description="Name of the choreography task, if any.")
    initiating_participant_ref: str | None = Field(None,
...
class GlobalTask(BaseModel):
    ...
    name: str | None = Field(None, description="Name of the global task, if any.")
...
class DataStore(BaseModel):
    ...
    name: str | None = Field(None, description="Name of the data store, if any.")
